/*
    ...
    0x18..0x1B  SIID - SI3, SI2, SI1, SI0 - SI2..SI0 makes up the SII (card number)
    ...
    0x00..0x7F  Reserve (nothing)
    # The dev docs from SPORTident says that 0x7C..0x7F is a block 2 identifier but it seems to not appear on SIAC, but who reads this block anyway
    ----            ----
    ---- BLOCK 0x03 ----
    0x38..0x3B  Clear/Check reserve (punch)
    0x3C..0x3E  New battery date, BYTE0=YY BYTE1=MM BYTE2=DD
...
#[cfg_attr(feature = "ts-rs", ts(export, export_to = "SIACBlock0.ts"))]
#[derive(Debug, Clone)]
struct Block0 {
    uid: u32,
    clear_check: Punch,
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[cfg_attr(feature = "ts-rs", derive(ts_rs::TS))]
#[cfg_attr(feature = "ts-rs", ts(export, export_to = "SIACBlock1.ts"))]
#[derive(Debug)]
struct Block1 {
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[cfg_attr(feature = "ts-rs", derive(ts_rs::TS))]
#[cfg_attr(feature = "ts-rs", ts(export, export_to = "SIACBlock3.ts"))]
#[derive(Debug)]
struct Block3 {
...
impl Block3 {
    pub fn deserialize(data: [u8; 128]) -> Result<Self, DeserializeBlockError> {
        ...
        let new_battery_date_bytes = extract_fixed!(&data, 0x3C..0x3E);
        let new_battery_date = NaiveDate::from_ymd_opt(
            (new_battery_date_bytes[0] as i32) + 2000,
            new_battery_date_bytes[1] as u32,
            new_battery_date_bytes[2] as u32,
        )
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[cfg_attr(feature = "ts-rs", derive(ts_rs::TS))]
#[cfg_attr(feature = "ts-rs", ts(export, export_to = "SIACBlock4.ts"))]
#[derive(Debug)]
struct Block4 {
    punches: Vec<Punch>,
